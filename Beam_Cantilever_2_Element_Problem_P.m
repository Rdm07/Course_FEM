...
% Cantilever Beam under 'P' Point load at end

ND = [1 2 3];               % Nodes
EL = [1 2];                 % Elements
DoF = [1 2 3 4 5 6];        % DoFs
% Moment of Inertia and Young's Modulus already defined as Symbols
RN = [1 2];                 % Restrained DoF
URN = [3 4 5 6];            % Unrestrained DoF
n_RN = length(RN);
...
KeGTemp2 = subs(KeGTemp, [E, I, Le, P], [E1, I1, Le1, 100000]);
KeG = subs(KeG, [E, I, Le, P], [E1, I1, Le1, 100000]);
F = subs(F, [E, I, Le, P, R1, R2], [E1, I1, Le1, 100000, 0, 0]);
